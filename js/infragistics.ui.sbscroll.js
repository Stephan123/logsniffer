/*
* Infragistics.Web.ClientUI Scroll 13.1.20131.1012
*
...
(function ($) {
	...
	$.extend($.ui.igSbScroll, { version: "13.1.20131.1012" });
...
$(document).delegate("div:jqmData(role='page')", "pageinit", function (e) {
    ...
    // VS 09/14/2012 Bug 121240 latest jquery mobile removes height, sets minHeight, sets overflow:hidden, etc.
    // try to get around those new features
    // old codes:
    //$(this).attr("style", "height:460px;width:320px;overflow:hidden;");
    // new codes:
    var me = this;
    $(this).css("width", "320px").css("overflow", "hidden");
    setTimeout(function () {
